...
// Statistik Perkembangan Penduduk
$route['statistik/perkembangan-penduduk'] = 'first/statistik/perkembangan-penduduk';
$route['first/perkembangan-penduduk']     = 'first/perkembangan_penduduk';
