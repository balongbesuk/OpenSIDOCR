	...
	<form id="form_simpan_pdf" action="<?= site_url('keluarga/simpan_import_pdf') ?>" method="POST" class="form-horizontal">
		...
		<div class="box box-solid box-info">
			<div class="box-header with-border">
				<h4 class="box-title"><strong>INFORMASI KARTU KELUARGA (HEADER)</strong></h4>
			</div>
			<div class="box-body">
		...
		<div class="box box-solid box-primary">
			<div class="box-header with-border">
				<h4 class="box-title"><strong>ANGGOTA KELUARGA (<?= count($parsed['members']) ?> Orang)</strong></h4>
			</div>
			<div class="box-body">
								...
								<tr>
									...
									<td class="text-center">
										...
										<?php elseif (!empty($m['status_dasar']) && $m['status_dasar'] == 2): ?>
											<span class="label label-danger" title="Penduduk Tercatat Meninggal di DB"><i class="fa fa-times-circle"></i> Meninggal</span>
		...
		<div class="modal-footer">
			...
			<button type="submit" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Simpan ke Database</button>
		</div>
	</form>
</div>
