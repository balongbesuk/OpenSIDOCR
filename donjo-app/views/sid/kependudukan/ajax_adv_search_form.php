		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="form-group">
					...
					<input class="form-control input-sm" type="text" placeholder="Nama Ayah" id="nama_ayah" name="nama_ayah" value="<?= $nama_ayah ?>"></input>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					<label for="nama_ibu">Nama Ibu</label>
					<input class="form-control input-sm" type="text" placeholder="Nama Ibu" id="nama_ibu" name="nama_ibu" value="<?= $nama_ibu ?>"></input>
				</div>
			</div>
		</div>
	</div>
