						...
						<?php if ($main): ?>
							<?php foreach ($main as $key => $data): ?>
								<tr class="text-center" align="center">
									...
									<td class="text-left" align="left"><?= strtoupper($data['DUSUN'])?></td>
							...
							<?php endforeach; ?>
							<!-- Hitung Total Rekapitulasi Cetak -->
							<?php
								$totals = [
									'WNA_L_AWAL' => 0, 'WNA_P_AWAL' => 0, 'WNI_L_AWAL' => 0, 'WNI_P_AWAL' => 0, 'KK_JLH' => 0, 'KK_ANG_KEL' => 0,
									'WNA_L_TAMBAH_LAHIR' => 0, 'WNA_P_TAMBAH_LAHIR' => 0, 'WNI_L_TAMBAH_LAHIR' => 0, 'WNI_P_TAMBAH_LAHIR' => 0,
									'WNA_L_TAMBAH_MASUK' => 0, 'WNA_P_TAMBAH_MASUK' => 0, 'WNI_L_TAMBAH_MASUK' => 0, 'WNI_P_TAMBAH_MASUK' => 0,
									'WNA_L_KURANG_MATI' => 0, 'WNA_P_KURANG_MATI' => 0, 'WNI_L_KURANG_MATI' => 0, 'WNI_P_KURANG_MATI' => 0,
									'WNA_L_KURANG_KELUAR' => 0, 'WNA_P_KURANG_KELUAR' => 0, 'WNI_L_KURANG_KELUAR' => 0, 'WNI_P_KURANG_KELUAR' => 0,
									'WNA_L_AKHIR' => 0, 'WNA_P_AKHIR' => 0, 'WNI_L_AKHIR' => 0, 'WNI_P_AKHIR' => 0, 'KK_AKHIR_JML' => 0, 'KK_AKHIR_ANG_KEL' => 0
								];
								foreach ($main as $row) {
							...
							?>
							<tr style="font-weight: bold; background-color: #e0e0e0;" class="text-center" align="center">
								<td colspan="2">JUMLAH / TOTAL</td>
								<td><?= show_zero_as($totals['WNA_L_AWAL'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_P_AWAL'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_L_AWAL'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_P_AWAL'], '-') ?></td>
								<td><?= show_zero_as($totals['KK_JLH'], '-') ?></td>
								<td><?= show_zero_as($totals['KK_ANG_KEL'], '-') ?></td>
								<td><?= show_zero_as($totals['KK_JLH'] + $totals['KK_ANG_KEL'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_L_TAMBAH_LAHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_P_TAMBAH_LAHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_L_TAMBAH_LAHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_P_TAMBAH_LAHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_L_TAMBAH_MASUK'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_P_TAMBAH_MASUK'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_L_TAMBAH_MASUK'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_P_TAMBAH_MASUK'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_L_KURANG_MATI'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_P_KURANG_MATI'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_L_KURANG_MATI'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_P_KURANG_MATI'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_L_KURANG_KELUAR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_P_KURANG_KELUAR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_L_KURANG_KELUAR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_P_KURANG_KELUAR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_L_AKHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNA_P_AKHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_L_AKHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['WNI_P_AKHIR'], '-') ?></td>
								<td><?= show_zero_as($totals['KK_AKHIR_JML'], '-') ?></td>
								<td><?= show_zero_as($totals['KK_AKHIR_ANG_KEL'], '-') ?></td>
								<td><?= show_zero_as($totals['KK_AKHIR_JML'] + $totals['KK_AKHIR_ANG_KEL'], '-') ?></td>
								<td>-</td>
							</tr>
						<?php endif; ?>
					</tbody>
