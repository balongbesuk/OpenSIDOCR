...
<?php
$CI = (function_exists('get_instance') && class_exists('CI_Controller', false)) ? get_instance() : null;
$baseUrl = $CI ? $CI->config->base_url() : '/';
?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= $baseUrl ?>assets/css/AdminLTE.css" />
</head>
		...
		<div class="error-page">
			...
			<div class="error-content">
				...
				<p>
					...
					Versi <?= function_exists('AmbilVersi') ? (config_item('nama_aplikasi') . ' ' . AmbilVersi()) : '' ?>.
					...
					<?php if ($status_code >= 500) : ?>
						...
						<br>
						Untuk sementara Anda dapat kembali ke halaman <a href="<?= defined('APP_URL') ? APP_URL : '/' ?>">awal</a>.
					<?php endif ?>
				</p>
			</div>
