				...
				<div class="col-md-8">
					<div class="box box-info">
						<div class="box-header with-border">
							...
							<a class="btn btn-social btn-flat bg-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block lineType" title="Garis Data" id="lineType" onclick="lineType();">
								<i class="fa fa-line-chart"></i>Garis Data
							</a>
							<?php if ($lap == '13'): ?>
...
foreach ($main as $data): $i++; ?>
		...
		series: [{
			...
			fillColor: {
				...
				stops: [
					[0, Highcharts.color('#00c0ef').setOpacity(0.5).get('rgba')],
					[1, Highcharts.color('#00c0ef').setOpacity(0).get('rgba')]
				]
			},
			data: [
			<?php foreach ($main as $data): ?>
