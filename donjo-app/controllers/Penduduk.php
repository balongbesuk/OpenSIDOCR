...
class Penduduk extends Admin_Controller
{
    ...
    {
        $list_session = ['umur', 'umur_min', 'umur_max', 'pekerjaan_id', 'status', 'agama', 'pendidikan_sedang_id', 'pendidikan_kk_id', 'status_penduduk', 'sex', 'status_dasar', 'cacat', 'cara_kb_id', 'status_ktp', 'id_asuransi', 'warganegara', 'golongan_darah', 'hamil', 'menahun', 'tag_id_card', 'nama_ayah', 'nama_ibu'];
    ...
    private function validasi_pencarian($post)
    {
        ...
        $data['nama_ayah']            = alfanumerik_spasi($post['nama_ayah']);
        $data['nama_ibu']             = alfanumerik_spasi($post['nama_ibu']);
    ...
    public function cetak($page = 1, $o = 0, $aksi = '', $privasi_nik = 0)
    {
        ...
        $list = $this->penduduk_model->list_data($o, 0);
