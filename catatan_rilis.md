...
1. **Migrasi & Integrasi Engine OCR Tercepat (RapidOCR ONNX Engine)**
   - Menggantikan Tesseract OCR bawaan dengan **RapidOCR ONNX Engine** lokal (`bin/rapidocr/win64/rapidocr.exe`).
   - Eksekusi pembacaan teks sangat cepat tanpa memerlukan instalasi perangkat lunak eksternal.

2. **Dukungan Format Berkas PDF & Gambar**
...
3. **Dukungan Kompatibilitas Ganda Format Kartu Keluarga**
   - **KK Format Lama**: Mendukung ekstraksi data pada KK dengan pengesahan TTD Manual & Stempel Basah Disdukcapil (penyaringan NIP 18-digit otomatis agar tidak mengontaminasi No KK).
...
4. **Kecerdasan Ekstraksi & Penyempurnaan Teks (Smart Parser)**
