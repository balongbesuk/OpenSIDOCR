$(document).ready(function() {
	...
	jQuery.validator.addMethod("judol", function(value, element) {
		var blacklist = [
			'judol', 'judi', 'togel', 'slot', 'gacor', 'jackpot', 'toto', 'hoki', 'depo', 'wd',
			'zeus', 'mahjong', 'betting', 'poker', 'casino', 'bet88', 'slot88', '777', 'maxwin',
			'hokitogel', 'metro4d', 'dewan4d', 'kebaya4d', 'sbctoto', 'aku4d', 'yok4d', 'roma77',
			'yolo4d', '234togel', 'mikro4d', 'gacototo', 'mytogel', 'sui4d', 'kuota4d', 'asian4d'
		];
		var pattern = new RegExp('\\b(' + blacklist.join('|') + ')\\b', 'i');
		return this.optional(element) || !pattern.test(value);
	}, "Konten mengandung kata terlarang (judi/spam)");
});
