...
<page orientation="portrait" format="210x330" style="font-size: 10pt">
	...
	<table class="disdukcapil">
       ...
       <tr>
			<td rowspan="6">4.</td>
			<td rowspan="6">Jenis Permohonan</td>
		</tr>
         <tr>
		...
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td colspan=5>a. Desa/Kelurahan</td>
       ...
       <tr>
			<td rowspan="6">6.</td>
			<td rowspan="6">Klasifikasi Kepindahan</td>
		</tr>
         <tr>
         	<td colspan=1 class="kotak"><?= isset($input['klasifikasi_pindah_id']) ? ($input['klasifikasi_pindah_id'] == 1 ? 'V' : '') : '' ?></td>
			<td colspan=23 class="padat">Dalam satu desa/ Kelurahan atau yang disebut dengan nama lain</td>
		</tr>
        <tr>
        	<td colspan=1 class="kotak"><?= isset($input['klasifikasi_pindah_id']) ? ($input['klasifikasi_pindah_id'] == 2 ? 'V' : '') : '' ?></td>
			<td colspan=23 class="padat">Antar desa/kelurahan atau yang disebut dengan nama lain dalam satu kecamatan</td>
		</tr>
		<tr>
        	<td colspan=1 class="kotak"><?= isset($input['klasifikasi_pindah_id']) ? ($input['klasifikasi_pindah_id'] == 3 ? 'V' : '') : '' ?></td>
			<td colspan=23 class="padat">Antar kecamatan atau yang disebut dengan nama lain dalam satu kabupaten/kota</td>
		</tr>
         <tr>
         	<td colspan=1 class="kotak"><?= isset($input['klasifikasi_pindah_id']) ? ($input['klasifikasi_pindah_id'] == 4 ? 'V' : '') : '' ?></td>
			<td colspan=23 class="padat">Antar kabupaten/kota dalam satu provinsi</td>
		</tr>
        <tr>
        	<td colspan=1 class="kotak"><?= isset($input['klasifikasi_pindah_id']) ? ($input['klasifikasi_pindah_id'] == 5 ? 'V' : '') : '' ?></td>
		...
		<tr>
			...
			<td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 1 ? 'V' : '') : '' ?></td>
			<td colspan=4 class="padat">Pekerjaan</td>
			<td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 3 ? 'V' : '') : '' ?></td>
			<td colspan=4 class="padat">Keamanan</td>
			<td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 5 ? 'V' : '') : '' ?></td>
			<td colspan=4 class="padat">Perumahan</td>
			<td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 7 ? 'V' : '') : '' ?></td>
			<td colspan=8 class="padat">Lainnya (sebutkan)</td>
		</tr>

		<tr><td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 2 ? 'V' : '') : '' ?></td>
			<td colspan=4 class="padat">Pendidikan</td>
			<td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 4 ? 'V' : '') : '' ?></td>
			<td colspan=4 class="padat">Kesehatan</td>
			<td colspan=1 class="kotak"><?= isset($input['alasan_pindah_id']) ? ($input['alasan_pindah_id'] == 6 ? 'V' : '') : '' ?></td>
		...
		<tr>
			...
			<td colspan=1 class="kotak"><?= isset($input['jenis_kepindahan_id']) ? ($input['jenis_kepindahan_id'] == 1 ? 'V' : '') : '' ?></td>
			<td colspan=11 class="padat">Kep. Keluarga</td>
			<td colspan=1 class="kotak"><?= isset($input['jenis_kepindahan_id']) ? ($input['jenis_kepindahan_id'] == 3 ? 'V' : '') : '' ?></td>
			<td colspan=10 class="padat">Kep. Keluarga dan Sbg. Angg. Keluarga</td>
		</tr>
		<tr>
		    <td colspan=1 class="kotak"><?= isset($input['jenis_kepindahan_id']) ? ($input['jenis_kepindahan_id'] == 2 ? 'V' : '') : '' ?></td>
			<td colspan=11 class="padat">Kep. Keluarga dan Seluruh Angg. Keluarga</td>
			<td colspan=1 class="kotak"><?= isset($input['jenis_kepindahan_id']) ? ($input['jenis_kepindahan_id'] == 4 ? 'V' : '') : '' ?></td>
		...
		<tr>
			...
			<td colspan=1 class="kotak"><?= isset($input['status_kk_tidak_pindah_id']) ? ($input['status_kk_tidak_pindah_id'] == 1 ? 'V' : '') : '' ?></td>
			<td colspan=8 class="padat">Numpang KK</td>
			<td colspan=1 class="kotak"><?= isset($input['status_kk_tidak_pindah_id']) ? ($input['status_kk_tidak_pindah_id'] == 2 ? 'V' : '') : '' ?></td>
		...
		<tr>
			...
			<td colspan=1 class="kotak"><?= isset($input['status_kk_pindah_id']) ? ($input['status_kk_pindah_id'] == 1 ? 'V' : '') : '' ?></td>
			<td colspan=8 class="padat">Numpang KK</td>
			<td colspan=1 class="kotak"><?= isset($input['status_kk_pindah_id']) ? ($input['status_kk_pindah_id'] == 2 ? 'V' : '') : '' ?></td>
			<td colspan=8 class="padat">Membuat KK Baru</td>
		</tr>
		<tr>
			<td>12.</td>
